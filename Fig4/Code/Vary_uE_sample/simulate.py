...
plt.plot(tau_values_sim, cross_sim[ii_neuron_1,ii_neuron_2], color='#FFBAD2', linewidth = 4)

plt.axvline(x=0, color='0', ls='-', linewidth=0.7)

plt.plot(tau_values, np.flipud(cross[ii_neuron_1,ii_neuron_2]), color='#AAAAAA', linewidth=0.3)
plt.plot(tau_values, cross[ii_neuron_1,ii_neuron_2], color='#FF1A66')
